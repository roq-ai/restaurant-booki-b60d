  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Streamlining your dining experience with seamless table reservations, while empowering restaurant staff to manage bookings and menus efficiently."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Streamlining your dining experience with seamless table reservations, while empowering restaurant staff to manage bookings and menus efficiently.`}
            </Text>
            <Box
