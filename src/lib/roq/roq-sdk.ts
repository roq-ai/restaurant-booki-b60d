...
import type { Prisma, chef, menu, reservation, restaurant, table, user } from './types';
...
interface ChefSDK {
  create: <T extends Prisma.chefCreateArgs, R extends CheckSelect<T, chef, Prisma.chefGetPayload<T>>>(
    data: Prisma.SelectSubset<T, Prisma.chefCreateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  createMany: <T extends Prisma.chefCreateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.chefCreateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  update: <T extends Prisma.chefUpdateArgs, R extends Prisma.chefGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.chefUpdateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  updateMany: <T extends Prisma.chefUpdateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.chefUpdateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  upsert: <T extends Prisma.chefUpsertArgs, R extends Prisma.chefGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.chefUpsertArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  delete: <T extends Prisma.chefDeleteArgs, R extends Prisma.chefGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.chefDeleteArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  deleteMany: <T extends Prisma.chefDeleteManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.chefDeleteManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  findMany: <T extends Prisma.chefFindManyArgs, R extends GetFindResult<Prisma.$chefPayload<DefaultArgs>, T>[]>(
    args: Prisma.SelectSubset<T, Prisma.chefFindManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  count: <T extends Prisma.chefCountArgs, R extends number>(
  ...
  findFirst: <T extends Prisma.chefFindFirstArgs, R extends GetFindResult<Prisma.$chefPayload<DefaultArgs>, T>>(
...
export class RoqClient {
  ...
  private initSDK() {
    ...
    this.chef = {
      create: async function createChef<
        T extends Prisma.chefCreateArgs,
        R extends CheckSelect<T, chef, Prisma.chefGetPayload<T>>,
      >(data: Prisma.SelectSubset<T, Prisma.chefCreateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/chef/create`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      createMany: async function createManyChef<T extends Prisma.chefCreateManyArgs, R extends Prisma.BatchPayload>(
        data: Prisma.SelectSubset<T, Prisma.chefCreateManyArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/chef/createMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      update: async function updateChef<T extends Prisma.chefUpdateArgs, R extends Prisma.chefGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.chefUpdateArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/chef/update`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      updateMany: async function updateManyChef<T extends Prisma.chefUpdateManyArgs, R extends Prisma.BatchPayload>(
        data: Prisma.SelectSubset<T, Prisma.chefUpdateManyArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/chef/updateMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      upsert: async function upsertChef<T extends Prisma.chefUpsertArgs, R extends Prisma.chefGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.chefUpsertArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/chef/upsert`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      delete: async function deleteChef<T extends Prisma.chefDeleteArgs, R extends Prisma.chefGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.chefDeleteArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/chef/delete`;
      ...
      deleteMany: async function deleteManyChef<T extends Prisma.chefDeleteManyArgs, R extends Prisma.BatchPayload>(
        data: Prisma.SelectSubset<T, Prisma.chefDeleteManyArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/chef/deleteMany`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, false>(
          reqUrl,
          {
      ...
      findMany: async function findManyChef<
        T extends Prisma.chefFindManyArgs,
        R extends GetFindResult<Prisma.$chefPayload<DefaultArgs>, T>[],
      >(args: Prisma.SelectSubset<T, Prisma.chefFindManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/chef/findMany`;
      ...
      count: async function countChef<T extends Prisma.chefCountArgs, R extends number>(
        args: Prisma.SelectSubset<T, Prisma.chefCountArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/chef/count`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      findManyWithCount: async function findManyWithCountChef<
        T extends Prisma.chefFindManyArgs,
        R extends GetFindResult<Prisma.$chefPayload<DefaultArgs>, T>[],
        C extends number,
      >(args: Prisma.SelectSubset<T, Prisma.chefFindManyArgs>, options?: RequestOptions) {
        ...
        const [data, count] = await Promise.all([
          ctx.chef.findMany(args, options),
          ctx.chef.count(
            {
              distinct,
              orderBy,
      ...
      findFirst: async function findFirstChef<
        T extends Prisma.chefFindFirstArgs,
        R extends GetFindResult<Prisma.$chefPayload<DefaultArgs>, T>,
      >(args?: Prisma.SelectSubset<T, Prisma.chefFindFirstArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/chef/findFirst`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
